...
<div class="container mt-4">
    ...
    <h5>{{ isset($plan) ? 'Edit Subscription Plan' : 'Create Subscription Plan' }}</h5>
    ...
    <div class="form-card mt-3">
        <form id="planForm">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control" rows="3">{{ old('description', $plan->decscription ?? '') }}</textarea>
